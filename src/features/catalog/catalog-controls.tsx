  ...
  return (
    <div className="flex flex-col gap-3">
      <button
        ...
        aria-expanded={isVisibleOnMobile}
        onClick={() => setIsVisibleOnMobile((current) => !current)}
      >
        {isVisibleOnMobile ? 'Mostrar filtros' : 'Ocultar filtros'}
      </button>

      <section
        id="catalog-controls"
        className={`catalog-controls surface-card rounded-3xl border-slate-200/80 ${
          isVisibleOnMobile ? 'hidden md:block' : 'block'
        }`}
      >

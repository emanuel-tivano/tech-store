...
export const products: ProductSeed[] = [
  {
    ...
    qtySold: 312,
    stock: 18,
    imageUrl: '/products/samsung-odyssey-g5-27.webp',
    freeShipment: true,
    isFeatured: true,
  ...
  },
  {
    ...
    qtySold: 148,
    stock: 11,
    imageUrl: '/products/lg-ultrawide-29.webp',
    freeShipment: true,
    isFeatured: false,
    categorySlug: 'monitores',
  },
  {
    ...
    qtySold: 427,
    stock: 26,
    imageUrl: '/products/keychron-k8-pro.webp',
    freeShipment: true,
    isFeatured: true,
  ...
  },
  {
    ...
    qtySold: 289,
    stock: 14,
    imageUrl: '/products/logitech-mx-keys-s.webp',
    freeShipment: false,
    isFeatured: false,
    categorySlug: 'teclados',
  },
  {
    ...
    qtySold: 511,
    stock: 19,
    imageUrl: '/products/logitech-g-pro-x-superlight-2.webp',
    freeShipment: true,
    isFeatured: true,
    categorySlug: 'mouses',
  },
  {
    ...
    qtySold: 167,
    stock: 21,
    imageUrl: '/products/razer-deathadder-v3.webp',
    freeShipment: false,
    isFeatured: false,
    categorySlug: 'mouses',
  },
  {
    ...
    qtySold: 236,
    stock: 17,
    imageUrl: '/products/hyperx-cloud-iii-wireless.webp',
    freeShipment: true,
    isFeatured: true,
  ...
  },
  {
    ...
    qtySold: 118,
    stock: 29,
    imageUrl: '/products/sony-wh-ch720n.webp',
    freeShipment: true,
    isFeatured: false,
    categorySlug: 'auriculares',
  },
